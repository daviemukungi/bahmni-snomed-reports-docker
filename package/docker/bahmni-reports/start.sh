...
java -cp .;/opt/bahmni-reports/lib/extensions-1.0-SNAPSHOT.jar  -jar $SERVER_OPTS $DEBUG_OPTS /opt/bahmni-reports/lib/bahmni-embedded-tomcat.jar -cp /opt/bahmni-reports/lib/extensions-1.0-SNAPSHOT.jar